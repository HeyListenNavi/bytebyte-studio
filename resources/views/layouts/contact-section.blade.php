<div class="grid w-full gap-20 md:grid-cols-2">
    ...
    <div class="divide-secondary/20 divide-y">
        <div class="flex flex-col gap-6 py-10">
            ...
            <a href="https://wa.me/526642677530?text=Hola%2C%20quiero%20más%20información%20sobre%20sus%20servicios" target="_blank"
        ...
        <div class="flex flex-col gap-6 py-10">
            ...
            <x-button.text href="mailto:contacto@bytebitestudio.com?subject=Consulta%20sobre%20servicios&body=Hola%2C%20me%20gustar%C3%ADa%20saber%20m%C3%A1s%20sobre%20sus%20servicios.%20Gracias!" target="_blank"
        ...
        <div class="flex flex-col gap-6 py-10">
            ...
            <x-button.text href="https://www.instagram.com/bytebitestudio" target="_blank"
